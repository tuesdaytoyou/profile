<template>
  <div class="audio_box flex_column">
    ...
    <div class="flex_column" style="position:absolute;top:5740px;background-color:black;width:100%;height:1362px;">
      <img v-if="curIndex == 1" :src="getCloudUrl('audio_list1.png')" />
      <iframe v-if="curIndex == 2" style="border: 1px solid rgba(0, 0, 0, 0.1);" width="1600" height="1362"
      ...
      <!-- <iframe v-if="curIndex == 2" style="border: 1px solid rgba(0, 0, 0, 0.1);z-index:100;transform: scale(0.47, 0.47)"
        width="1920" height="1080"
        src="https://www.figma.com/file/9C4FkOastcC6AIpjh8PkuA/%E9%A1%B9%E7%9B%AE%E6%95%B4%E7%90%86?node-id=141%3A33439"
        allowfullscreen></iframe> -->
      <img v-if="curIndex == 3" :src="getCloudUrl('audio_list3.png')" />
      <img v-if="curIndex == 4" :src="getCloudUrl('audio_list4.png')" />
    </div>
